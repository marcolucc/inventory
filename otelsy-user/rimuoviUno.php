...
// if session is not set this will redirect to login page
    ...
    //Se c'è almeno un prodotto lo tolgo altyrimenti devo generare un'errore
     date_default_timezone_set('Europe/Rome');
        $dt=date('Y-m-d H:i:s');
        $query1=mysql_query("INSERT INTO `movimento`( `idProdotto`, `idUtente`, `nomeProdotto`, `prezzo`, `quantitaPrima`, `quantitaDopo`, `dataMovimento`) VALUES (".$prodotto['id'].",".$_SESSION['user'].",'".$prodotto['nomeProdotto']." ".$prodotto['brand']."',".$prodotto['prezzo'].",".$prodotto['quantita'].",0,'".$dt."');");
    	
	$query=mysql_query("UPDATE magazzino SET quantita = 0, dataUltimaModifica='".$dt."' WHERE codiceBarre = ".$codiceBarre." ;");
	$_SESSION['successoRemove']=1;
	header("Location: index.php");
