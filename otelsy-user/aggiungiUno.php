...
// if session is not set this will redirect to login page
    ...
    $dt=date('Y-m-d H:i:s');
    $query1=mysql_query("INSERT INTO `movimento`( `idProdotto`, `idUtente`, `nomeProdotto`, `prezzo`, `quantitaPrima`, `quantitaDopo`, `dataMovimento`) VALUES (".$prodotto['id'].",".$_SESSION['user'].",'".$prodotto['nomeProdotto']." ".$prodotto['brand']."',".$prodotto['prezzo'].",".$prodotto['quantita'].",".$prodotto['quantita']." + 1,'".$dt."');");
