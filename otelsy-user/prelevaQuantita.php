	...
	if( isset($_POST['btn-login']) ) {	
		...
		if (!$error) {
		    ...
		    if ($row['quantita'] >= $quantita){
				...
				$query1=mysql_query("INSERT INTO `movimento`( `idProdotto`, `idUtente`, `nomeProdotto`, `prezzo`, `quantitaPrima`, `quantitaDopo`, `dataMovimento`) VALUES (".$prodotto['id'].",".$_SESSION['user'].",'".$prodotto['nomeProdotto']." ".$prodotto['brand']."',".$prodotto['prezzo'].",".$quantita.",".$prodotto['quantita']."-".$quantita.",'".$dt."');");
