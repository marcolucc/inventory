   ...
   $prodotto=mysql_fetch_array($query);
	...
	if( isset($_POST['btn-login']) ) {	
		...
		if (!$error) {
		    ...
		    $query2=mysql_query("UPDATE magazzino SET dataUltimaModifica = '".$dt."' WHERE codiceBarre = ".$codiceBarre);
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
    	...
    	<div class="col-md-12">
            ...
            <div class="form-group">
            	...
            	<div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-barcode"></span></span>
            	<input type="number" name="quantita" class="form-control" placeholder="Quantità" value="<?php echo $quantita1; ?>" maxlength="255" autofocus/>
                </div>
