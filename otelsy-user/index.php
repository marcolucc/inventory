  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        ...
        <li><a href="generaCodice.php"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Crea Codice a Barre</a></li>
        <ul class="nav navbar-nav navbar-right">
            
					<li><a href="../logout.php"><span class="glyphicon glyphicon-log-out"></span>&nbsp;Esci da <?php echo $userRow['nome']; if($userRow['privilegi']==1){echo " (AMMINISTRATORE)";} else {echo " (UTENTE)";}; ?></a></li>
